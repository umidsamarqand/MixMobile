...
export const HUAWEI_MODELS: PhoneModel[] = [
  ...
  },
  {
    ...
    storageOptions: ['256GB', '512GB', '1TB'],
    ramOptions: ['12GB', '16GB'],
    displaySpecs: '6.75" LTPO OLED 120Hz',
    chipset: 'Kirin 9030 Pro',
    cameraSpecs: '50MP Main (f/1.4-4.0, OIS) + 48MP Periscope Telephoto (4x, OIS) + 40MP Ultrawide',
    batterySpecs: '5750 mAh (100W Wired / 80W Wireless)',
    releaseYear: 2025,
  ...
  },
  {
    ...
    colorVariants: ['Black Glaze', 'White Glaze', 'Gold Glaze'],
    storageOptions: ['256GB', '512GB', '1TB'],
    ramOptions: ['12GB', '16GB'],
    displaySpecs: '6.8" LTPO OLED 120Hz',
    chipset: 'Kirin 9020',
    cameraSpecs: '50MP Main (f/1.6-4.0, OIS) + 48MP Telephoto (4x, OIS) + 40MP Ultrawide',
    batterySpecs: '5700 mAh (100W Wired / 80W Wireless)',
    releaseYear: 2025,
