...
export const VIVO_MODELS: PhoneModel[] = [
  ...
  },
  {
    ...
    brand: 'vivo',
    modelName: 'X300 Pro',
    colorVariants: ['Black', 'Brown', 'Blue', 'White'],
    storageOptions: ['256GB', '512GB', '1TB'],
    ramOptions: ['16GB'],
    ...
    batterySpecs: '6510 mAh Silicon-Carbon (90W Wired / 40W Wireless)',
    releaseYear: 2025,
  ...
  },
  {
    ...
    cameraSpecs: 'Zeiss 50MP Main (OIS) + 12MP Telephoto + 12MP Ultrawide',
    batterySpecs: '4810 mAh (66W Wired)',
    releaseYear: 2022,
    overview: 'Zeiss-tuned camera flagship, popular in resale.',
    pros: ['Zeiss camera tuning', 'Strong low-light performance'],
    cons: ['Smaller battery vs newer models'],
    recommendedFor: 'Value flagship buyers.',
    gsmarena_url: 'https://www.gsmarena.com/res.php3?sSearch=vivo%20X90'
  },
  {
    id: 'm-vivo-y17s',
    brand: 'vivo',
    ...
    releaseYear: 2024,
    overview: 'Entry-level Y series device.',
    pros: ['Very affordable', 'Large battery'],
    cons: ['LCD screen', 'Slow charging'],
    recommendedFor: 'Entry-level buyers.',
    gsmarena_url: 'https://www.gsmarena.com/res.php3?sSearch=vivo%20Y17s'
  },
  {
    id: 'm-vivo-x-fold5',
    brand: 'vivo',
    ...
    storageOptions: ['512GB', '1TB'],
    ramOptions: ['16GB'],
    displaySpecs: '8.03" Inner AMOLED + 6.53" Outer AMOLED',
    chipset: 'Snapdragon 8 Elite',
    cameraSpecs: 'Zeiss 50MP Main (OIS) + 50MP Periscope Telephoto + 50MP Ultrawide',
    batterySpecs: '6000 mAh Silicon-Carbon (80W Wired / 40W Wireless)',
    releaseYear: 2025,
    overview: 'Book-style foldable flagship with Zeiss-tuned triple camera.',
    pros: ['Zeiss camera tuning', 'Periscope telephoto zoom', 'Large battery'],
    cons: ['Premium price'],
    recommendedFor: 'Foldable enthusiasts wanting flagship cameras.',
    gsmarena_url: 'https://www.gsmarena.com/res.php3?sSearch=X%20Fold5'
  },
  {
    id: 'm-vivo-x-flip',
    brand: 'vivo',
    modelName: 'X Flip',
    colorVariants: ['Diamond Black', 'Sunset Gold'],
    storageOptions: ['256GB'],
    ramOptions: ['12GB'],
    displaySpecs: '6.74" Inner AMOLED + 3.25" Outer AMOLED',
    chipset: 'Snapdragon 8 Gen 2',
    cameraSpecs: '50MP Main (OIS) + 12MP Ultrawide',
    batterySpecs: '4400 mAh (44W Wired)',
    releaseYear: 2024,
    overview: 'Clamshell foldable with Zeiss camera tuning.',
    pros: ['Zeiss camera tuning', 'Large outer display'],
    cons: ['Non-flagship-tier chipset for the price'],
    recommendedFor: 'Clamshell foldable enthusiasts.',
    gsmarena_url: 'https://www.gsmarena.com/res.php3?sSearch=X%20Flip'
  },
];
