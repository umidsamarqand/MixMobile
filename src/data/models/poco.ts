...
export const POCO_MODELS: PhoneModel[] = [
  ...
  },
  {
    ...
    storageOptions: ['256GB', '512GB', '1TB'],
    ramOptions: ['12GB', '16GB'],
    displaySpecs: '6.67" WQHD+ AMOLED 120Hz',
    chipset: 'Snapdragon 8 Elite (3nm)',
    cameraSpecs: '50MP Main (f/1.61, OIS) + 50MP Floating Telephoto + 32MP Ultrawide',
    batterySpecs: '5300 mAh (120W Wired / 50W Wireless)',
    releaseYear: 2025,
